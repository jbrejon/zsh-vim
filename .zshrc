...
bindkey '<ctrl-p>' history-search-backward
...
#alias vim="~/localinstall/bin/vim"
#alias vimpager="~/localinstall/bin/vimpager"
...
then
        if [ $host = "berlioz" ]
        then
                export PATH=/dsk/l1/misc/brejon/gcc/bin:$PATH
                export LD_LIBRARY_PATH=/dsk/l1/misc/brejon/gcc/lib64
        fi
fi
